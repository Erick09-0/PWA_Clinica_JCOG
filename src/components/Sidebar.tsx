  ...
  const SidebarContent = () => (
    <>
        ...
        <div className="space-y-1">
          {menuItems.map((item, index) => {
            ...
            return (
              ...
              >
                <motion.div
                  whileHover={{ rotate: item.id === 'configuracion' ? 180 : 0, scale: 1.2 }}
                ...
                <span
                  className={`flex-1 text-left font-medium ${
                    item.danger && !isActive ? 'text-red-500' : ''
                  }`}
                >
                  {item.label}
                </span>
      ...
      <motion.div
        ...
        className="mt-auto pt-4 border-t border-gray-200 dark:border-slate-700"
      >
        <motion.div
          whileHover={{ scale: 1.02 }}
          className="px-4 py-4 bg-gradient-to-br from-gray-50 to-blue-50/30 dark:from-slate-900 dark:to-blue-950/30 backdrop-blur rounded-2xl border border-gray-200/50 dark:border-slate-700/50 transition-all"
        >
          <div className="flex items-center gap-3">
            <div className="relative">
              ...
              <div className="absolute -bottom-0.5 -right-0.5 w-3.5 h-3.5 bg-green-500 rounded-full border-2 border-white dark:border-slate-800 shadow-sm" />
            </div>
