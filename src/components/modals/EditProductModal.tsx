...
import { X, Package, Tag, MapPin, DollarSign, Calendar, TrendingDown, Save, Loader2 } from 'lucide-react';
      ...
      {isOpen && (
        <>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
            ...
            >
              {/* Header */}
              <div className="sticky top-0 z-10 bg-gradient-to-r from-blue-500 to-indigo-600 text-white p-6 rounded-t-3xl">
                <div className="flex items-start justify-between">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-sm opacity-80 mt-1">Modifica la información del producto</p>
                    </div>
                  </motion.div>
              ...
              <form onSubmit={handleSubmit} className="p-6 space-y-4">
                ...
                >
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="flex-1 py-3 bg-gradient-to-r from-blue-600 to-indigo-700 hover:from-blue-700 hover:to-indigo-800 text-white font-medium rounded-xl transition-all shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                  >
                    {loading ? (
                      <>
